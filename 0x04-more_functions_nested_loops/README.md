Project tasks on C functions.
File 0-isupper.c is a function that checks for uppercase character.

File 1-isdigit.c is a function that checks for a sequence of  digits (0 through 9).
...
File 6-print_line.c is a function that draws a straight line object in the terminal.

File 7-print_diagonal.c is a function that draws a diagonal line object on the terminal.
